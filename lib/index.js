...
const mainIntentHandlers = require("./parliament/stateHandlers.js").mainHandlers;
const nullIntentHandlers = require("./parliament/stateHandlers.js").nullHandlers;
const whatsOnIntentHandlers = require("./parliament/stateHandlers.js").whatsOnHandlers;
...
exports.handler = function (event, context, callback) {
    ...
    alexa.registerHandlers(mainIntentHandlers, whatsOnIntentHandlers, nullIntentHandlers, audioEventHandlers);
