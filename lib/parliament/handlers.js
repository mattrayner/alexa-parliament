...
module.exports = {
    ...
    'WhatsOnIntent': function(callback, done) {
        ...
        let lords_options = commons_options
        ...
        let generate_message = function() {
            ...
            handlers.emit(':askWithCard', message.join(' '), message.join(' '), handlers.t('WHATS_ON_CARD_TITLE'), message.join(' '))
