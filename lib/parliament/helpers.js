...
module.exports = {
     ...
     * let callback = function(events) { winston.info("Got events: " + events); };
    ...
    getEvents: function (uri_options, callback) {
        rp(uri_options.main)
            .then(function (body) {
                ...
                if( events.count <= 0 ) {
                    rp(uri_options.future)
                        .then(function(body){
                            ...
                            winston.info("E: WhatsOnIntent FUTURE_DATA Error: " + err.name ? err.name : "");
                            winston.info(err);
                ...
                winston.info("E: WhatsOnIntent Error: " + err.name ? err.name : "");
                winston.info(err);
    ...
    generateVenueEventList: function(venue_order, venues, future=false) {
        winston.info('Generate event string');
