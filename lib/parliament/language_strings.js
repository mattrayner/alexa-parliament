...
module.exports = {
    "en-GB": {
        "translation": {
            ...
            "NEXT_EVENT": "The next event will be on",
            ...
            "HELP_TEXT": "Parliament for Alexa, can tell you what's on today at the Houses of Parliament. Try saying, 'what's on', to hear about the events at both houses. Alternatively, say, 'whats on at the commons', or, 'whats on in the lords', to hear about the events at a specific house.",
            "HELP_TEXT_REPROMPT": "Try saying, 'what's on'.",
            "WHATS_ON_HELP_TEXT": "You can either say, 'yes', to hear more. Or, 'no', to cancel.",
            "LAUNCH_TEXT": "Welcome to Parliament. Say, 'what's on', to find out whats happening today at the Houses of Parliament. Or say, 'help', for more information.",
