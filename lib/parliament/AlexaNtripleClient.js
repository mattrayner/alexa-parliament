...
class AlexaNtripleClient {
    ...
    constructor(endpoint) {
        console.log("Creating AlexaNtripleClient instance.");
    ...
    __handleNtripleAPIRequest(requestOptions, fulfill, reject) {
        ...
        Https.get(requestOptions, (response) => {
            ...
            console.log(`NTriple API responded with a status code of : ${response.statusCode}`);
            ...
            response.on('end', () => {
                ...
                parser.parse(data_string, function(error, triple, prefixes){
                    if(triple) {
                        ...
                        console.log('Parsing completed; Triple store contains %d triples.', store.size);
...
module.exports = AlexaNtripleClient;